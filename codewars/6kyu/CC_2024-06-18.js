...
let buildDeck = ["ace", "two", "three", "four", "five", "six", "seven", "eight", "nine", "ten", "jack", "queen", "king"].map(val => ["hearts", "spades", "diamonds", "clubs"].map(type => `${val} of ${type}`)).reduce((a, c) => a.concat(c));